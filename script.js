...
// this is used to scrol trigger to play the video.
gsap.to("#page>video",{
    scrollTrigger:{
        trigger:`#page>video`,
        start:`2% top`,
...
//this is used to pin the main page till the video is on.
gsap.to("#page",{
    scrollTrigger:{
        trigger:`#page`,
        start:`top top`,
...
// this is used to control the opacity of the intro and vision pro tag.
gsap.to("#page-bottom",{
    scrollTrigger:{
        trigger:`#page-bottom`,
        start:`5% top`,
